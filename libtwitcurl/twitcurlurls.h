...
namespace twitCurlDefaults
{
    ...
    const std::string TWITCURL_MEDIADATA__BASE64_STRING = "media_data=";
    const std::string TWITCURL_MEDIADATA__BINARY_STRING = "media=";
...
namespace twitterDefaults
{
    ...
    const std::string TWITCURL_BASE_UPLOADURL = "upload.twitter.com/1.1/";
    ...
    /* Media Upload URLs */
    const std::string TWITCURL_MEDIAUPLOAD_URL = TWITCURL_BASE_UPLOADURL + "media/upload";
